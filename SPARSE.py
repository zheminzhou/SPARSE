...
def _mapDB(argv) :
    ...
    parser.add_argument('-n', '--dbname', help='Name for the database folder. REQUIRED. ', required=True)
    parser.add_argument('-m', '--mapDB', help='Name for the sub-database. REQUIRED. ', required=True)
...
def _report(argv) :
    ...
    parser.add_argument('--level', help='Level to report, default: s. Details see documents for the seqlist format.', default='s')
